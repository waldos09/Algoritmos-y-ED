...
//////////////////////////////
        /*INSERCION*/
//////////////////////////////
void ordenainsercion(cf*arreglo,int tam){
    cf pivote;
    int i,j;
    i=1;
    for(i=1;i<tam;i++){
...
void crearArchivoBinario(char* dato,int l,cf* chYfrec,int cantChar){
    FILE*archivoBIN;
    archivoBIN=abrirArchivo("archivoBIN.txt","wb");
...
//////////////////////////////////////////////////////////
            /*FIN DE TABAL DE FRECUENCIAS*/
//////////////////////////////////////////////////////////
    ordenainsercion(chYfrec,cantChar-1);
